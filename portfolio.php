...
<head>
	...
	<link href='https://fonts.googleapis.com/css?family=Varela+Round' rel='stylesheet' type='text/css'>
  	...
  	<link rel="stylesheet" type="text/css" href="preload_css.css">


  	<!--script -->
  	<script src="jquery-3.1.1.min.js" type="text/javascript"></script>
  	<script src="circle-progress.min.js" type="text/javascript"></script>
  	<script src="slidr.min.js" type="text/javascript"></script>
	<script src="https://cdnjs.cloudflare.com/ajax/libs/materialize/0.97.8/js/materialize.min.js"></script>
	<script type="text/javascript" src="phaser.min.js"></script> 
  	<script src="test-canvas.js" type="text/javascript" charset="utf-8" async defer></script>
